...
test("user message uses terminal-bg whitespace padding around a colored content row", () => {
	initTheme("dark");
	...
	// 底部留白: OSC133 end+final, visually blank, 无背景色块, 无 ▔ 前景线
